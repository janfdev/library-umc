...
app.get("/categories", (req, res) =>
  categoryController.getAllCategories(req, res, {} as any),
);
app.get("/categories/:id", (req, res) =>
  categoryController.getCategoryById(req, res, {} as any),
);
...
describe("CategoryController Unit Tests", () => {
  ...
  describe("GET /categories", () => {
    it("harus mengembalikan 200 dengan list categories", async () => {
      const mockData = [{ id: 1, name: "Fiksi", description: "Buku fiksi" }];

      const spy = vi
        .spyOn(CategoryService.prototype, "getAllCategories")
