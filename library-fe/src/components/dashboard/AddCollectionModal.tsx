...
export default function AddCollectionModal({
  ...
  const inputClass =
    "w-full px-4 py-3 bg-white border border-slate-200 rounded-[14px] focus:outline-none focus:ring-4 focus:ring-slate-100 focus:border-slate-300 transition-all font-semibold text-slate-800 placeholder:text-slate-300 text-sm";
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="space-y-5 overflow-y-auto max-h-[75vh] pr-2 custom-scrollbar"
      >
        <div>
